...
pub fn implementation(
    ...
    let component_tree =
        components::Tree::new(&manifest, validate_namespaces_documented)?;
    ...
    let concept_tokens = concept_tree.to_token_stream(&component_tree,&api_name, project_path.as_path())?;
